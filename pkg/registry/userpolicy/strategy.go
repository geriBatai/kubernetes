...
// strategy implements behavior for UserPolicy objects
type strategy struct {
	runtime.ObjectTyper
	api.NameGenerator
}

// Strategy is the default logic that applies when creating and updating UserPolicy
...
func (strategy) Validate(ctx api.Context, obj runtime.Object) field.ErrorList {
	return validation.ValidateUserPolicy(obj.(*extensions.UserPolicy))
}
...
func (strategy) ValidateUpdate(ctx api.Context, obj, old runtime.Object) field.ErrorList {
	return validation.ValidateUserPolicyUpdate(obj.(*extensions.UserPolicy), old.(*extensions.UserPolicy))
}
...
func Matcher(label labels.Selector, field fields.Selector) generic.Matcher {
	return generic.MatcherFunc(func(obj runtime.Object) (bool, error) {
		sa, ok := obj.(*extensions.UserPolicy)
		if !ok {
			return false, fmt.Errorf("not a user policy")
		}
...
func SelectableFields(policy *extensions.UserPolicy) labels.Set {
